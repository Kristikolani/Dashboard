...
const PaginationComments = ({ total }: Props) => {
  const setPageNumber = useCommentQueryStore((s) => s.setPageNumber);
  const navigate = useNavigate();
  const pageNumber = useCommentQueryStore((s) => s.commentQuery.pageNumber);
